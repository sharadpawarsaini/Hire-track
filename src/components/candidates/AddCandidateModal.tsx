...
export default function AddCandidateModal({ isOpen, onClose, jobs }: AddCandidateModalProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      <div className="w-full max-w-lg bg-gray-950 border border-gray-850 rounded-xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-150">
        ...
        <form action={formAction} className="p-6 space-y-4">
          <div>
            <label className="block text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1" htmlFor="name">Full Name *</label>
            <input
              id="name"
              name="name"
              type="text"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1" htmlFor="email">Email *</label>
              <input
                id="email"
                name="email"
                type="email"
            ...
            <div>
              <label className="block text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1" htmlFor="phone">Phone</label>
              <input
                id="phone"
                name="phone"
                type="tel"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1" htmlFor="source">Source</label>
              <input
                id="source"
                name="source"
                type="text"
            ...
            <div>
              <label className="block text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1" htmlFor="jobId">Apply to Job *</label>
              <select
                id="jobId"
                name="jobId"
                required
